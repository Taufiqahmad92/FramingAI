...
text <- pdf_text("./FramingAI.PDF")
writeLines(text, "./FramingAI.text")
file_path <- "./FramingAI.text"
...
write_csv(final_data, "/Users/taufiqahmad/Desktop/Code/FramingAI/data/final_data.csv")
```
...
files <- list.files("/Users/taufiqahmad/Desktop/Code/FramingAI/data/extracted", pattern="*.txt") %>% 
  as.data.frame() |> 
  rename(filename = 1) |> 
...
mutate(filepath = paste0("~/Desktop/Code/FramingAI/data/extracted/", filename))
...
write_csv(articles_df, "/Users/taufiqahmad/Desktop/Code/FramingAI/data/articles_df.csv")
```
...
### Another attempt to cleaning script
```{r}
